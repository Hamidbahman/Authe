        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationId = table.Column<long>(type: "bigint", nullable: false),
                    ApplicationId1 = table.Column<long>(type: "bigint", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteUser = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ModifyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbConfigurationLock_tbApplication_ApplicationId1",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ApplicationId", "ApplicationId1", "CaptchaNeeded", "CreateDate", "DeleteDate", "DeleteUser", "FailedLoginAmountBeforeCaptcha", "LockTimeInterval", "LockType", "ModifyDate", "ModifyUser" },
                values: new object[] { 1L, 1L, null, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, (short)3, 300, (short)0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbConfigurationLock_ApplicationId1",
                table: "tbConfigurationLock",
